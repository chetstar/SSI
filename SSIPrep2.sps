...
save outfile='I:\temp\MatchedSSN.sav' /keep ssnSSI  ssiNumber SSIcountyReportAA SSIcountyReport.
...
get file='I:\SSI\SSIqueue\JustMaxedSSI.sav' /keep ssnSSI SSIcountyReportAA Name NameLast NameFirst.
match files /table='I:\temp\MatchedSSN.sav' /file=* /by ssnSSI.
*freq ssiNumber.
...
save outfile='I:\SSI\SSIqueue\JustMaxedSSINameMatch.sav' .

get file='I:\SSI\SSIqueue\JustMaxedSSINameMatch.sav' .
...
sort cases by lnamessi fnamessi.
match files/table='I:\SSI\SSIqueue\JustMaxedSSINameMatch.sav' /file=* /by lnamessi fnamessi.
